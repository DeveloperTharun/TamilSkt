    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            try:
                ...
                tt = await s.reply_text(f"<b>𝙄𝙈𝙋𝙊𝙍𝙏𝘼𝙉𝙏  ↦↦↦⃟👉 This Movie File will be deleted in 5min. So Please forward this File Before Download 📥</b>",disable_web_page_preview=True, quote=True)
